...
<%@ page import="com.chensisi.model.Product" %>
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								...
								com.chensisi.model.Product p=(com.chensisi.model.Product)pageContext.findAttribute("p");
								int pid=p.getCategoryId();
								Connection con=(Connection)application.getAttribute("con");
								String catName=com.chensisi.model.Category.findByCategoryId(con,pid);
							%>
